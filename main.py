...
# 彩虹屁
def caihongpi():
    if (caihongpi_API != "http://api.tianapi.com/caihongpi/index"):
...
# 健康小提示API
def health():
    if (health_API != "http://api.tianapi.com/healthtip/index"):
        conn = http.client.HTTPSConnection('api.tianapi.com')  # 接口域名
...
# 星座运势
def lucky():
    if (lucky_API != "http://api.tianapi.com/healthtip/index"):
        conn = http.client.HTTPSConnection('api.tianapi.com')  # 接口域名
...
# 励志名言
def lizhi():
    if (lizhi_API != "http://api.tianapi.com/lzmy/index"):
        conn = http.client.HTTPSConnection('api.tianapi.com')  # 接口域名
